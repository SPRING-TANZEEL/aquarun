...
export default function App() {
  ...
  if (userRole === 'admin' && currentTenant) return <AdminDashboard tenantId={currentTenant.id} hasMapFeature={currentTenant.has_map_feature || false} user={{ full_name: currentTenant.business_name, role: 'admin' }} onLogout={handleLogout} />
