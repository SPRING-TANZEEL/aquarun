...
export default function App() {
  ...
  if (userRole === 'admin' && currentTenant) return <AdminDashboard tenant={currentTenant} adminUser={{ full_name: currentTenant.business_name, role: 'admin' }} onLogout={handleLogout} />
