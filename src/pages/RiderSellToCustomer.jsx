...
export default function RiderSellToCustomer({ rider, tenantId, preSelectedCustomer, onClearPreSelected, isOnline, dbReady }) {
  ...
  return (
    <div>
      <h2 style={{ fontSize: '18px', fontWeight: '700', color: '#333', marginBottom: '4px' }}>🏪 Sell to Customer</h2>
      <p style={{ fontSize: '12px', color: '#888', marginBottom: '16px' }}>Sell outside of orders — walk-in or unplanned delivery</p>
